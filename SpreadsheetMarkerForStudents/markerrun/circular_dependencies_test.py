        ...
        try:
            ...
            try:
                ...
                error = self.sAssertTrue(False,0,"Cell A1 contains the formula =A2+A3+A4+A5, and now a try has been done to " \
                                         ...
                                         + "corresponding CircularDependencyException should have been thrown. Instead no exception has been thrown")
            except CircularDependencyException as err:
                print("CircularDependencyException has been thrown as expected")
